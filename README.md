...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-20 23:57`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/035d93bc-d1df-4ef7-8c9c-bf69a30bacac.git
$ cd 035d93bc-d1df-4ef7-8c9c-bf69a30bacac
```
